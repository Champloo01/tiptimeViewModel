...
import com.example.tiptime.ui.theme.theme.TipTimeTheme
...
fun TipTimeLayout(
    ...
    Column(
        ...
        EditNumberField(
            ...
            value = tipTimeUiState.amount,
            onValueChanged = { tipTimeViewModel.updateUserGuessAmountInput(it) },
            modifier = Modifier
        ...
        EditNumberField(
            ...
            value = tipTimeUiState.tipPercent,
            onValueChanged = { tipTimeViewModel.updateUserGuessTipInput(it) },
            modifier = Modifier
                .padding(bottom = 32.dp)
                .fillMaxWidth(),
        )
